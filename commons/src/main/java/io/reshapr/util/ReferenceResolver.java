...
public class ReferenceResolver {
   ...
   private final HttpSecret repositorySecret;
    ...
    */
   public ReferenceResolver(String baseRepositoryUrl, HttpSecret repositorySecret, boolean disableSSLValidation) {
   ...
   public String getReferenceContent(String relativePath, Charset encoding) throws IOException {
      ...
      if (referenceFile == null) {
         log.infof("Downloading a reference file at %s", remoteUrl);
         ...
         if (remoteUrl.startsWith("http")) {
            ...
            log.debugf("Reading local file %s", remoteUrl);
